    ...
    <div className="bg-[#9fc0af] min-h-screen relative overflow-hidden">
      ...
      <div className="relative min-h-screen bg-white overflow-hidden">
        ...
        <img
          ...
          className="hidden md:block absolute right-0 top-10 h-full w-1/2 object-contain pointer-events-none float-animation"
        />
        ...
        <img
          src={bike}
          alt="Delivery Illustration"
          className="md:hidden w-full max-h-[250px] object-contain mt-6 px-6"
        />

        {/* CONTENT */}
        <div className="relative z-10 flex flex-col md:flex-row min-h-screen items-center justify-start px-6 md:px-16 py-10">
          <div className="mt-10 md:ml-20 max-w-xl text-center md:text-left">
            <h1 className="text-2xl sm:text-5xl md:text-6xl font-extrabold leading-tight">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div data-aos="fade-left">
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              3arrow is India’s fast-growing instant commerce platform built to
              empower local businesses and transform the way customers shop.
            </p>
      ...
      <div className="bg-[#f3f7f4] py-20 px-6 md:px-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              “The best decision for my business. 3arrow handles logistics while
              I focus on product quality.”
            </p>
      ...
      <div className="bg-[#f3f7f4] py-20 px-6 md:px-20" data-aos="fade-up">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Our mission is to empower local sellers and brands by providing a
              seamless digital platform that connects them directly to millions
              of customers.
            </p>

            <p className="text-gray-600 leading-relaxed">
              We aim to simplify commerce, enable faster deliveries, and create
              exponential growth opportunities for businesses of all sizes
              across India.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              ...
              way possible. We saw neighbourhood stores struggling to go digital
              and customers waiting days for essentials. So we decided to change
              that.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                Our delivery ecosystem ensures ultra-fast fulfillment with safe
                and reliable last-mile operations across cities.
              </p>
            </div>
          ...
          >
            ...
            <p className="max-w-2xl mx-auto text-lg leading-relaxed">
              Whether you're a small retailer, a large distributor, or a growing
              brand, 3arrow provides the digital infrastructure, logistics
              support, and customer reach to accelerate your growth.
            </p>
